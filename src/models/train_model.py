...
# Below plot will create a bar chart to compare the accuracy of the models
...
# Code below comes from the Training random forest feature within the import code
